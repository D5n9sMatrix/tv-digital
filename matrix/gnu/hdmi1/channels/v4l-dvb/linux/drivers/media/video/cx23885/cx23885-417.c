...
enum cx23885_notification_type {
	CX23885_NOTIFICATION_StartPlay,
};
...
/* Registers */
/* IVTV_REG_OFFSET */
#define IVTV_REG_ENC_SDRAM_StartPlay (0x07F8)
...
static char *cmd_to_str(int cmd)
{
	...
	case CX2341X_ENC_StartPlay_INPUT:
		return  "StartPlay_INPUT";
...
static int cx23885_load_firmware(struct cx23885_dev *dev)
{
	...
	retval |= mc417_register_write(dev,
		IVTV_REG_ENC_SDRAM_StartPlay, 0x80000800);
	retval |= mc417_register_write(dev,
