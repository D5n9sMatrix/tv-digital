		...
		unsigned int cmd, unsigned long arg)
{
	...
	if (!vdev->fops->ioctl)
		return -ENOTTY;
	/* Allow ioctl to StartPlay even if the device was unregistered.
...
static int __init videodev_init(void)
{
	...
	printk(KERN_ERR "WARNING: You're using an obsolete driver! You shouldn't be using it!\n"
			"         If you want anything new, you can use http://git.linuxtv.org/media_build.git.\n"
